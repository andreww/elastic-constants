...
def test_cells_eq(cell_in, cell_out):
...
if __name__ == "__main__":
    ...
    test_abc(9.5, 8.6, 5.2, 90.000, 106.239525, 90.000) # Should be OK
    test_cell(jadeite_out) # This should not rotate
    ...
    triclin_out = [[ 9.0270942 ,  0.47424434,  1.21596251],
                   ...
                   [ 0.        ,  0.        ,  5.25071424]]
    test_cells_eq(rot_cell(triclin_in), triclin_in)
    npt.assert_almost_equal(rot_cell(triclin_in), triclin_out)
    test_cells_eq(triclin_in, triclin_out)

    print "abc test"
    test_abc(10, 11, 12, 91, 91, 91)
